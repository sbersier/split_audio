# split_audio.py
Split long speech files into chunks with specified average, minimum and maximum duration. It looks for silences and uses them to segment cleanly the original file. 
