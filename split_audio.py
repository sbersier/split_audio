...
argParser.add_argument("-i", "--intervals", dest="list_intervals", help="output the list of intervals in \"intervals.txt\")",action='store_true', default=False)
...
for i in range(len(S)-1):
    ...
    if duration > min_duration and duration<max_duration:
        ...
        name=outputFolder+os.sep+str(int(start)).zfill(10)+'_'+str(int(end)).zfill(10)+'.wav'
